...
<html>
        <head>
                <title>visualCaptcha PHP and jQuery (multiple) Demo - The best captcha alternative</title>
                <meta charset="utf-8">
                <meta name="keywords" content="visualcaptcha, captcha, multiple captcha, jquery, php, turing test, mobile-friendly, accessible, accessibility, retina-friendly, better captcha, fancy captcha, captcha alternative, demo">
        ...
        <body>
            <div class="wrap">
                ...
                <div class="pre-captcha-wrapper multiple">
                    <!-- Form one -->
                    <div class="captcha-wrapper multiple">
                        <h1>Fill in the form and submit it</h1>

                        <form name="frm-one" class="frm-sample" action="try" method="post">
                            ...
                            <a id="check-is-filled" class="check-captcha info-btn">Check if visualCaptcha is filled</a>
